...
const getData = async (category: null | TypeCategories, id: string | null) => {
  if (category != null) {
    try {
...
const parseData = (data: TypeProduct[] | object, id: string | null) => {
...
export const MoreProducts: FC<Props> = async ({ limit = 4, category = null, id = null }) => {
